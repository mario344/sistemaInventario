...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class BodegasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descricion,Estado")] Bodega bodega)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descricion,Estado")] Bodega bodega)
        {
            if (id != bodega.Id)
            {
                return NotFound();
